...
import { CandyGuard, CandyMachine, DefaultGuardSet, mintV1 } from '@metaplex-foundation/mpl-core-candy-machine'
...
export function useMintAsset({ collection }: { collection: CollectionV1 }) {
  ...
  return useMutation({
    mutationFn: async ({ cm, cg, guard }: { cm: CandyMachine; cg: CandyGuard; guard: DefaultGuardSet }) => {
